...
//    static constexpr type increment_value = type(0x400);
    ...
    static constexpr type threadid_mask = type(0x7F); // was 0x1F
    static constexpr type lock_bit = type(0x80); // was 0x20
    static constexpr type nonopaque_bit = type(0x100); // was 0x40
    static constexpr type user_bit = type(0x200); // was 0x80
    static constexpr type increment_value = type(0x1000); // was 0x400
...
public:
    ...
    virtual unsigned long long int get_identity() const;
};
